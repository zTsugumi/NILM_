...
from train import train_model, train_model_wrapper
...
def get_arguments():
    ...
    parser.add_argument("--path", default="out_train\\dishwasher")
    parser.add_argument("--data-gen", default=False)
    parser.add_argument("--train", action="store_true", default=True)
    parser.add_argument("--tune", action="store_true", default=False)
    parser.add_argument("--epochs", default=5)
    parser.add_argument("--disable-plot", action="store_true", default=True)
    parser.add_argument("--disable-random", action="store_true", default=True)
