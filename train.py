...
from utils import error, load_dataset
...
def train_model(datapath, data_gen, output, appliance, hparams, doplot=None, reload=True):
    """
    ...
    if data_gen:
        ...
        filename = os.path.join(output, "dataset.pt")
        transform, train_dataset, eval_dataset = load_dataset(filename)
